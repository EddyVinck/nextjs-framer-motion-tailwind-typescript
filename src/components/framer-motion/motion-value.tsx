...
export const MotionValueExample = () => {
  ...
  return (
    <AnimationWrapper
      title="Motion value (drag left or right)"
      resettable={false}
    >
      <div className="bg-slate-900 border-2 border-slate-400 rounded-md pt-4 px-2 max-w-xs w-full">
        <div className="flex h-72 pb-24 flex-col justify-between items-center">
